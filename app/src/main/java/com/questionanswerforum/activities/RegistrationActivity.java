...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        spinner_studteach = (Spinner) findViewById(R.id.spinner_studteach);
        ...
        btn_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner_studteach.getSelectedItem().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Select One ption", Toast.LENGTH_SHORT).show();
                    return;
                }
                submitData();
                finish();
    ...
    private void submitData() {
        ...
        Call<ResponseData> call = service.register(name, phno, email, uname, pwd, studtech);
